...
orderRouter.put('/shipped', middleware.ensureAuthenticated(), (req, res) => shippedOrderController.execute(req, res))
orderRouter.put('/received', middleware.ensureAuthenticated(), (req, res) => receivedOrderController.execute(req, res))
export { orderRouter }
