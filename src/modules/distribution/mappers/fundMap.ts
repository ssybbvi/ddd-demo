    ...
    const fundOrError = Fund.create(
      {
        ...
        incomeMemberId: MemberId.create(new UniqueEntityID(raw.incomeMemberId)).getValue(),
        paymentMemberId: MemberId.create(new UniqueEntityID(raw.paymentMemberId)).getValue(),
